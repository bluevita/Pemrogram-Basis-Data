...
<head>
    ...
    <title>Dashboard Admin - Ubah Data Pasien</title>
...
<body>
    <div class="kiri">
        ...
        <section class="isi">
            <a class="nav-link" href="indexAdmin.php">Data Pasien</a>
        </section>
        <section class="isi">
            <a class="nav-link" href="indexPakar.php">Data Pakar</a>
        </section>
        <div class="sidebar-heading">
    ...
    <div class="kanan">
        <div class="container-fluid">
            ...
            <!-- Content Row -->
            <div class="row">
                <form action="function.php?act=ubahPasien&id_user=<?= $user['id_user']; ?>" id="ubah" method="POST" onsubmit="confirmSubmit(event)">
