...
// Query untuk mengambil data solusi yang berelasi dengan penyakit
$querySolusi = mysqli_query($koneksi, "SELECT solusi.id_solusi, penyakit.penyakit, solusi.deskripsi_relasi, solusi.solusi, solusi.metode_pengobatan 
                                      FROM solusi 
                                      INNER JOIN penyakit ON solusi.penyakit = penyakit.penyakit");
...
<body>
    <div class="kiri">
        ...
        <section class="isi">
            <a class="nav-link" href="indexRelasi.php"><span>Data Relasi</span></a>
        </section>
        <div class="sidebar-heading">
    ...
    <div class="kanan">
        <div class="container-fluid">
            ...
            <div class="card shadow mb-12">
                ...
                <div class="card-body">
                    <a href="tambahSolusi.php" class="btn btn-primary my-2 px-2">Tambah Data Solusi</a> <!-- Button placed here -->
                        ...
                        <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                            <thead>
                                <tr>
                                    <th>Aksi</th>
                                    <th>Penyakit</th>
                                    <th>Deskripsi Relasi</th>
                                    <th>Solusi</th>
                                    <th>Metode Pengobatan</th>
                                </tr>
                            </thead>
                            <tbody>
                                <?php while ($data = mysqli_fetch_assoc($querySolusi)) { ?>
                                    <tr>
                                        <td>
                                            <a class="badge badge-pill badge-primary" href="ubahSolusi.php?id_solusi=<?= $data['id_solusi']; ?>">edit</a> |
                                        ...
                                        <td><?= $data['penyakit']; ?></td>
                                        <td><?= $data['deskripsi_relasi']; ?></td>
                                        <td><?= $data['solusi']; ?></td>
                                        <td><?= $data['metode_pengobatan']; ?></td>
                                    </tr>
                                <?php } ?>
                            </tbody>
                        </table>
