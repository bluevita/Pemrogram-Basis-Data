...
// If the user is already logged in, redirect to their dashboard based on their role
                ...
                <form id="registrationForm" method="POST" action="function.php?act=register" class="needs-validation" novalidate>
                    ...
                    <div class="form-row">
                        <div class="col">
                            ...
                            <div class="valid-feedback">Bagus!</div>
                            <div class="invalid-feedback">Password min. 8 karakter</div>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col">
                            ...
                            <div class="invalid-feedback">Masukkan Tahun Lahir</div>
                        </div>
                    </div>
                    <div class="form-row">
                        <div class="col">
                            <label class="papan" for="jenis_kelamin">Jenis Kelamin</label>
